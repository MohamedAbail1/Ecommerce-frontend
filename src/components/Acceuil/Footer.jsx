      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-bold mb-4">ShopFlex</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/categories" className="text-gray-300 hover:text-white">Catégories</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/categories/electronics" className="text-gray-300 hover:text-white">Électronique</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Inscrivez-vous à notre newsletter pour recevoir les dernières offres et nouveautés.</p>
            <form className="flex">
              <input
                type="email"
      ...
      <div className="bg-gray-900">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/privacy" className="text-sm text-gray-400 hover:text-white">Politique de confidentialité</Link>
            <Link to="/cookies" className="text-sm text-gray-400 hover:text-white">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
